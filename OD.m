...
% % Тепловая модель силового трансформатора OD IEC 60076-7
% % Ввод параметров трансформатора из таблицы в приложении Е
% delta_theta_or = 49;     % input('введите delta_theta_or ');    % Рост температуры в верхних слоях в нормальном режиме, К
% delta_theta_hr = 29;     % input ('введите delta_theta_hr ');   % Превышение температуры ННТ над температурой в верхних слоях масла, К
