function [HST_max,TOT_max,AEQ,HST,TOT]=ONAF(PUL,AMB)
...
% % Тепловая модель силового трансформатора ONAF IEC 60076-7
% % Ввод параметров трансформатора из таблицы в приложении Е
% delta_theta_or = 52;     % input('введите delta_theta_or ');    % Рост температуры в верхних слоях в нормальном режиме, К
% delta_theta_hr = 26;     % input ('введите delta_theta_hr ');   % Превышение температуры ННТ над температурой в верхних слоях масла, К
% tao_0 = 150;             % input ('введите tao_0 ');            % Постоянная времени масла, мин
...
% k11 = 0.5;               % input ('введите k11 ');
% k21 = 2;                 % input ('введите k21 ');
